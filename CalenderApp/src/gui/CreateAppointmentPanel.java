...
//		boxModel.addElement(new Room(30, "TESTROM2"));
		 ...
		 * da den ikke kan v�re satt til null.
		 */
		...
		saveButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				for(int i = 0; i < model.size(); i++) {
					persons.add(model.getElementAt(i));
				}
				app.setParticipants(persons);
	...
	private void setModelContent(){
		ArrayList<Person> persons = client.fetchPersons("H");//M� gj�re noe her!
		// HER OGS�! DETTE FORKLARER IKKE HVA SOM M� GJ�RES.
		// I tilfellet noen andre m� gj�re arbeidet.
