...
public class MyAppointmentsPanel extends JPanel {
	...
	public MyAppointmentsPanel(final Client client, Person person, Appointment selectApp) {
		...
		removeAlarmButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				DateTime time = new DateTime((int)alarmYearSpinner.getValue(), (int)alarmMonthSpinner.getValue(), (int)alarmDaySpinner.getValue(), (int)alarmHourSpinner.getValue(), (int)alarmMinuteSpinner.getValue()); //�r, mnd, dag, time, minutt
